...
- 尚未證實：紀錄維護原因
  - 啟用 Unified Maintenance API
  - 檢查 description，確認某次維護原因
  - https://docs.cloud.google.com/unified-maintenance/docs/set-up-unified-maintenance
  - https://docs.cloud.google.com/network-connectivity/docs/interconnect/support/infrastructure-maintenance-events
...
- 如何限制 node service account 權限
  - google_container_node_pool 可以設定 node_config.oauth_scopes
  - node 權限會是 service account 的 iam role `∩` oauth_scopes
...
- private service access [要等最後一個用到的服務關閉四天後才能刪除](https://docs.cloud.google.com/sql/docs/mysql/configure-private-services-access)
