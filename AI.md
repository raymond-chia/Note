...
- 流程
  - https://python.langchain.com/v0.2/docs/how_to/chatbots_retrieval
    - 要用於 chat playground [參考](https://github.com/langchain-ai/langserve/issues/612#issuecomment-2119280059)
...
- 文字用的 vector store 可能要選 cohere 的 embedding, dimension 比較恰當 ??
- vector 針對 keyword 表現可能不如普通搜尋 ??
  - dense embeddings
...
- 範例
  ...
  - rag:
    - 接 azure: https://github.com/langchain-ai/langchain/blob/master/templates/rag-azure-search/rag_azure_search/chain.py
    - 轉成 chat playground: https://python.langchain.com/v0.1/docs/use_cases/chatbots/retrieval
